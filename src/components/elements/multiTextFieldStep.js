...
export default function MultiTextFieldStep({ setStep, setPayload, payload ,elementindex,setElementindex,inputElements}) {
  const classes = useStyles();
  const [submitted, setSubmitted] = useState(false);
  const [value, setValue] = React.useState('devcodebase');
